...
public class DatabaseService : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The hotel ID and date")] int hotelId, DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get missing hotel rooms bookings.")]
